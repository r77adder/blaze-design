...
export const withSettingsDefaults = (avatar: AvatarProfile): AvatarProfile => ({
  ...SETTINGS_DEFAULTS,
  ...avatar,
});
...
export const AVATARS_SEED: AvatarProfile[] = [
  {
    id: 'brenna',
    name: 'Brenna Walsh',
    imageUrl:
...
export type AvatarOption = Omit<AvatarProfile, 'id' | 'enabled' | 'videos' | 'campaigns'> & {
  id: string;
...
export function AvatarEditor({
  ...
  onDelete?: () => void;
  /** Reduced field set — shows only Name, Tone of voice, and Accent. Used by
   *  the avatar announcement flow where deep customization is out of scope. */
  compact?: boolean;
  /**
