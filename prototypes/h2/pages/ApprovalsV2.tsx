...
// Cloned from prototypes/approval-v2 (PR #46) and adapted for the h2 tree:
// PrototypeShell → H2Layout, data re-themed to CertaPro Austin.

// ── Image assets (Unsplash, CertaPro-themed) ──────────────────────────────────
...
const CAMPAIGNS: Campaign[] = [
  {
    id: 0,
    name: 'June Wave — Team & Interiors',
    dateRange: 'Jun 16 – Jul 4',
    badge: 'Campaigns',
    endDate: '2026-07-04', // future — active
    posts: [
      { id:0, type:'still',      date:'Jun 16  10:00am', dateSort:'2026-06-16T10:00', img:U7, caption:'Meet the crew behind the paint — same faces, same standards, every project. The team your neighbors ask for by name.' },
      { id:1, type:'story',      date:'Jun 16  10:00am', dateSort:'2026-06-16T10:01', img:U2, caption:'Behind the scenes: prep day on a Westlake exterior. The work you don\'t see is what makes the paint last.' },
      { id:2, type:'feed-video', date:'Jun 17  10:00am', dateSort:'2026-06-17T10:00', img:U3, caption:'Crew day in the life — from first walkthrough to final coat. Watch how a CertaPro project actually runs.' },
      { id:3, type:'story',      date:'Jun 18  10:00am', dateSort:'2026-06-18T10:00', img:U4, caption:'Interior season is coming — June booking slots for kitchen and cabinet projects are open now.' },
      { id:4, type:'carousel',   date:'Jun 20  10:00am', dateSort:'2026-06-20T10:00', img:U6, slides:5, caption:'Interior refresh inspiration — 5 looks from real Austin homes, painted by the same local crew.' },
      { id:5, type:'still',      date:'Jun 24  10:00am', dateSort:'2026-06-24T10:00', img:U5, caption:'The Lakeway kitchen reveal — cabinet refinishing that saved the homeowner roughly 70% versus replacement.' },
      { id:6, type:'carousel',   date:'Jun 27  11:00am', dateSort:'2026-06-27T11:00', img:U1, slides:4, caption:'Before & after: 4 exterior transformations from this spring — and what each homeowner chose for color.' },
      { id:7, type:'email',      date:'Jul 1  8:00am',   dateSort:'2026-07-01T08:00', img:U8, caption:'June newsletter — spring wrap-up, interior season preview, and the crew photos everyone asked about.' },
    ],
  },
  {
    id: 1,
    ...
    endDate: '2026-07-04', // future — active
    posts: [
      { id:100, type:'blog', date:'Jun 17  10:00am', dateSort:'2026-06-17T10:00', img:U6, caption:'Cabinet Refinishing vs. Replacement: The Real Cost Breakdown for Austin Kitchens' },
      { id:101, type:'blog', date:'Jun 21  10:00am', dateSort:'2026-06-21T10:00', img:U7, caption:'How to Choose an Exterior Paint Color That Works With Austin Limestone' },
      { id:102, type:'blog', date:'Jun 25  10:00am', dateSort:'2026-06-25T10:00', img:U2, caption:'Why Prep Determines How Long Your Paint Job Lasts (And How to Spot Shortcuts)' },
    ],
  },
  // ── Past campaigns (end date has passed) ──────────────────────────────────
  {
    id: 2,
    name: 'Spring Exterior Push 2026',
    dateRange: 'Mar 15 – Apr 5',
    badge: 'Campaigns',
    endDate: '2026-04-05', // past
    posts: [
      { id:200, type:'still',    date:'Mar 15  10:00am', dateSort:'2026-03-15T10:00', img:U1, caption:'Spring is the best season to paint in Austin — the booking window is open now.' },
      { id:201, type:'carousel', date:'Mar 18  9:00am',  dateSort:'2026-03-18T09:00', img:U3, slides:4, caption:'4 signs your exterior paint is overdue — chalking, hairline cracks, fading.' },
      { id:202, type:'email',    date:'Mar 22  8:00am',  dateSort:'2026-03-22T08:00', img:U8, caption:'April estimate slots are filling — book your free exterior walkthrough.' },
    ],
  },
  {
    id: 3,
    name: 'Cabinet Refresh — Spring Launch',
    dateRange: 'Feb 12 – Feb 21',
    badge: 'Campaigns',
    endDate: '2026-02-21', // past
    posts: [
      { id:300, type:'still',      date:'Feb 12  10:00am', dateSort:'2026-02-12T10:00', img:U4, caption:'Your kitchen, refinished — not replaced. The spring cabinet program starts now.' },
      { id:301, type:'story',      date:'Feb 14  9:00am',  dateSort:'2026-02-14T09:00', img:U5, caption:'Three days, one kitchen, a completely different feel.' },
      { id:302, type:'feed-video', date:'Feb 18  2:00pm',  dateSort:'2026-02-18T14:00', img:U2, caption:'Watch a cabinet refinish from sanding to final coat.' },
      { id:303, type:'email',      date:'Feb 20  8:00am',  dateSort:'2026-02-20T08:00', img:U7, caption:'Last call — February cabinet slots close Friday.' },
    ],
  },
];
        ...
        <div style={{ flex:1, padding:'0 10px 32px', display:'flex', flexDirection:'column' }}>
          <div style={{
            ...
            <div style={{ flex:1, padding:'10px 12px 10px', overflow:'hidden', display:'flex', flexDirection:'column', gap:5 }}>
              ...
              <p style={{ margin:0, fontSize:11, color:dark40, fontFamily:F }}>June 17, 2026</p>
              <p style={{ margin:0, fontSize:12, color:dark60, fontFamily:F, lineHeight:1.55, letterSpacing:'0.24px',
                ...
                Most Austin homeowners assume a tired kitchen means a full cabinet replacement — but refinishing the boxes you already have typically runs about a third of the cost and takes three days instead of three weeks. Here's how the numbers break down for a typical Austin kitchen, what determines whether your cabinets are good candidates, and where the savings actually come from.
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ flex:1, padding:'0 10px 32px', display:'flex', flexDirection:'column' }}>
          <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden', background:white, borderRadius:8, boxShadow:'0 2px 12px rgba(0,0,0,0.10), 0 1px 3px rgba(0,0,0,0.06)' }}>
            ...
            <div style={{ flex:1, padding:'10px 12px 10px', overflow:'hidden', display:'flex', flexDirection:'column', gap:5 }}>
              ...
              <p style={{ margin:0, fontSize:11, color:dark40, fontFamily:F }}>June 17, 2026</p>
              <p style={{ margin:0, fontSize:12, color:dark60, fontFamily:F, lineHeight:1.55, display:'-webkit-box', WebkitLineClamp:6, WebkitBoxOrient:'vertical' as const, overflow:'hidden' }}>Most Austin homeowners assume a tired kitchen means a full cabinet replacement — but refinishing typically runs about a third of the cost and takes three days instead of three weeks.</p>
            </div>
          </div>
        </div>
      ) : isPortrait ? (
...
function ApprovalV2Inner() {
  ...
  // View-as-client toggle — shared with the rest of H2 via context, so
  // arriving here from Home in client view keeps this page in client mode.
  ...
  const [internalStatuses, setInternalStatuses] = useState<Record<number, InternalStatus>>(() => {
    ...
    CAMPAIGNS.forEach(c => {
      ...
      c.posts.forEach((p, i) => {
        // Active campaigns start with the first two June Wave posts already
        // through internal review — so client view has content on first load.
        initial[p.id] = isPast
          ? (i % 2 === 0 ? 'readyForClient' : 'internalReview')
          : (c.id === 0 && i < 2 ? 'readyForClient' : 'internalReview');
      });
    });
    return initial;
  });
  ...
  return (
    <H2Layout
      title={
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <button
            onClick={() => navigate('/h2/living-doc')}
            style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 26, height: 26, borderRadius: 7, border: '1px solid var(--dark-10)', background: 'var(--light-100)', color: 'var(--dark-60)', cursor: 'pointer', padding: 0 }}
    ...
    >
      {/* Client view banner — same treatment as the Living Doc */}
      {clientView && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: 'var(--dark-90)', color: 'white', borderRadius: 10, padding: '10px 14px', marginBottom: 16 }}>
          <EyeOpen />
          <span style={{ fontSize: 13, flex: 1, fontFamily: F }}>
            Viewing as <strong style={{ fontWeight: 600 }}>Sarah Johnson</strong> — only content marked ready for client is visible.
          </span>
