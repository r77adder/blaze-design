      ...
      <div style={{ flex: 1, padding: '48px 28px 80px', minWidth: 0 }}>
        <div style={{ maxWidth: 1040, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 36 }}>
          ...
          <div style={{ marginBottom: -16 }}>
            <Heading level={1} style={{ marginBottom: 4 }}>Bright Day HVAC</Heading>
            <Text variant="metadata" color="var(--dark-40)" style={{ display: 'block' }}>
              brightdayhvac.com · Austin, TX · Scanned today ·{' '}
              <button
                type="button"
          ...
          <div style={{ textAlign: 'center', marginTop: 4 }}>
            <Text variant="label" color="var(--dark-40)">
              Scorecard generated by Blaze · A US-based marketing strategist reviews every result before you book.
            </Text>
          </div>
        </div>
      </div>
